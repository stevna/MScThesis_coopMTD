...
sudo killall python
sudo killall startMTDProactive2.sh
sudo killall startBashProActive.sh
...
/home/MalwareOne/workspace/runAllProActive/startMTDProactive2.sh > startMTDProactive2Logs.txt &
/home/MalwareOne/workspace/runAllProActive/startBashProActive.sh > startBashProActiveLogs.txt &
