...
def writeToLog(logText):
    f = open("/home/MalwareOne/workspace/evaluation/output.txt", "a")
...
def getTelnetPort():
    ...
    try:
        ...
        print("portInServiceFile:", portInServiceFile)
        print("telnetPort:", telnetPort)
...
#print(telnetPort)
# get the hostname might not work on a different linux distro, could also be done with subprocess
...
def listenToDeployer(HOST, PORT ):
    ...
    #this server cannot handle mutliple connections
    while True:
        ...
        while True: 
            ...
            if movingParameter == "IP":
                ...
                command = ['pkill', '-f', 'clientStartScanner']
                ...
                writeToLog("Gehostbyname used {str(seconds)}")
                ...
                if "found" in out:
                    ...
                    #print("The old port was: ", oldTelnetPort)
                    #print("The new port should be: ", movingParameterValue)
                    ...
                    print("timeToChangeBack", timeToChangeBack)
            ...
            #commands = commands.format(globalHOST, movingParameterValue)
            #time.sleep(15)
            #communication_socket.send("blub".encode("utf-8"))
...
def changePort(oldPort,newPort,communication_socket,timeToChangeBack, globalHOST):
    ...
    #changedPort = proc.stdout.decode("utf-8")
    #print("changedPort ",changedPort)
    ...
    if "found" in serviceCheck:
        ...
        #do mues meh de socket no close
    ...
    try:
        ...
        print("this is the not working command: ", command)
